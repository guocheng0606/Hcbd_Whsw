...
public class RefreshFrequencyEditActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_refresh_frequency_edit);
        ...
        if(null != configureInfo){
            ...
            etUnit.setText(configureInfo.getName());
            etValue.setText(configureInfo.getRemark());
        ...
        String[] strs = MyApplication.getInstance().getPowerStr("首页刷新频率").split(",");
        if(strs.length == 4){
            if(strs[2].equals("0")){
        ...
        switch (view.getId()){
            ...
            case R.id.btn_complete:
                if(TextUtils.isEmpty(etUnit.getText().toString())){
                    ToastUtils.showShortToast(RefreshFrequencyEditActivity.this,"请输入单位");
                    return;
                }
                if(TextUtils.isEmpty(etValue.getText().toString())){
                    ToastUtils.showShortToast(RefreshFrequencyEditActivity.this,"请输入数值");
                    return;
                }
                httpEdit();
                break;
    ...
    private void httpEdit() {
        OkGo.<String>post(MyApplication.getInstance().getBsaeUrl() + HttpUrlUtils.configure_type_edit_url)
                ...
                .params("name", etUnit.getText().toString())
                ...
                .execute(new StringCallback() {
                    ...
                    public void onStart(Request<String, ? extends Request> request) {
                        ...
                        ProgressDialogUtils.showLoading(RefreshFrequencyEditActivity.this);
                    }
